...
class W3SchoolsPage extends StatefulWidget {
  const W3SchoolsPage({Key? key}) : super(key: key);

  @override
  State<W3SchoolsPage> createState() => _W3SchoolsPageState();
}

class _W3SchoolsPageState extends State<W3SchoolsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Color(0xff00ab6d),
