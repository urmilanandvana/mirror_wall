...
class HotstarPage extends StatefulWidget {
  const HotstarPage({Key? key}) : super(key: key);

  @override
  State<HotstarPage> createState() => _HotstarPageState();
}

class _HotstarPageState extends State<HotstarPage> {
